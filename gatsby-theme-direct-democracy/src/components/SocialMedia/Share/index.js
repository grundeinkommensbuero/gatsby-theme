...
export default ({
  ...
  const facebookText = facebookShareText
    ? fixedEncodeURIComponent(facebookShareText)
  ...
  const twitterText = twitterShareText
    ? fixedEncodeURIComponent(twitterShareText)
  ...
  const facebookUrl = facebookTargetUrl
    ? facebookTargetUrl
  ...
  return (
    <div className={className}>
      ...
      <div className={s.iconContainer}>
        <SocialMediaButton
          icon="Facebook"
          link={`https://www.facebook.com/share.php?u=${facebookUrl}&quote=${facebookText}`}
          iconSize={iconSize}
